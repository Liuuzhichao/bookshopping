		...
		<div class="topbar_content">
			...
			<div class="topbar_content_right">
				<ul>
					...
					<li>|</li>
					<li><a
						href="${pageContext.request.contextPath }/showCreatOrder">我的订单</a>
					</li>
				</ul>
			</div>
		</div>
				...
				<div>
					<ul>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=novel">小说</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=cartoon">童书</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=study">学习考试</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=literature">文学</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=music">音乐</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=art">艺术</a>
						</li>
						<li><img src="images/plane.png" align="center"> <a
							href="${pageContext.request.contextPath }/showProductKinds?type=science">科技</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="main">
			...
			<div class="tuijian">
				...
				<div class="tuijian_product" style="min-width: 750px">
					<c:forEach items="${productsList }" var="pro">
						<div style="float: left; margin: 10px 30px;">
							...
							</a> <br> <span>${pro.price }</span> <br> <a
								href="${pageContext.request.contextPath }/showProductInformation?id=${pro.id }">查看详细</a>
							<br>
							<!-- 加入购物车 -->
							<button
								style="background: #87520E; color: white; line-height: 15px; font-size: 13px; border-radius: 5px; border: #87520E; cursor: pointer;"
								onclick="addCart('${pro.id}')">加入购物车</button>
				...
				<div style="float: none; margin-top: 20px;">
					<a
						href="${pageContext.request.contextPath }/showIndex?page=${pageBean.page-1}">
