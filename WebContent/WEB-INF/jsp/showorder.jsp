	...
	<div class="cart_content">
		...
		<div align="center" id="cart">
			<table class="maintable" border="1" style="text-align: center">
				<tbody>
					<tr
						style="background: #87520E; color: white; line-height: 40px; font-size: 18px; border: #87520E solid 1px; text-align: center">
						<td>订单编号</td>
						<td>订单信息</td>
						<td>订单状态</td>
					...
					<tr>
						...
						<td width="50%">
							<table
								style="border-collapse: collapse; border: #f8e49b; width: 100%; text-align: center;"
								border="1">
								<tbody>
									<tr
										style="background: #87520E; color: white; line-height: 35x; border: white solid 1px;">
										<td width="45%">商品名称</td>
										<td width="20%">商品单价</td>
										<td width="20%">购买数量</td>
										<td>总价</td>
						...
						<td><a
							href="/bb/pay.jsp?id=a5f10151-6841-4e13-a4c3-570af3d8968f&amp;money=279.0">${order.paystate }</a>
						</td>

						<td><a
							href="/bb/order?method=del&amp;id=a5f10151-6841-4e13-a4c3-570af3d8968f">取消订单</a>
						</td>
					</tr>
						</c:forEach>
					</c:if>
