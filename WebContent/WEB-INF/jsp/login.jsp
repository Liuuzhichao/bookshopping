...
<head>
    ...
    <script type="text/javascript">
    	//页面加载事件,用jQuery实现,相当于onload()方法,加载页面就执行
    	//记住用户名的方法
    	$(function(){
    		//获取cookie信息
    		//cookie用el表达式
    		var username = "${cookie.username.value}"
    		//对cookie信息以utf-8格式进行解码
    		username = window.decodeURI(username,"utf-8");
    		//alert(username);
    		//document.getElementById("username").value = username;
    		//jquery方式 ,用获取到的cookie信息来填充用户名
...
<body>
    ...
    <div class="estore_content" style="min-height: 800px;">
        ...
        <form action="login" method="post" onsubmit="return checkForm();" id="loginform">
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="checkbox" name="autologin"  id="autologin" value="on" style="width: 25px"/>自动登录
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
