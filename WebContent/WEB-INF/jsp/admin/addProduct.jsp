			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						action="${pageContext.request.contextPath }/saveProduct" onsubmit="return checkCategory()" 
						enctype="multipart/form-data"><!-- 不对文件进行编码,表单包含上传文件时必须使用该值 -->
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input name="cbtime" type="date" value="" class="form-control" required="required">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input name="imgpic" type="file" value="" class="form-control" required="required"
