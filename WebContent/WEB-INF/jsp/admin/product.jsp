					...
					<div class="ibox-content">
						...
						<div class="table-responsive">
							...
							<table class="table table-striped">
								...
								<tbody>
									<!-- 根据model对象传递的键值对的键值productsList来进行绑定数据 -->
									<c:forEach items="${productsList }" var="pro" varStatus="count">
										<tr>
											<!-- count是一个对象,取count对象中的值 -->
											<td>${count.count }</td>
											<td>${pro.name }</td>
											<td>${pro.price }</td>
											<td>${pro.category }</td>
											...
											<td>
												...
												<!-- 删除,${pageContext.request.contextPath }/delProduct?id=${pro.id} -->
...
<script type="text/javascript">
	function delProduct(id){
		...
		if(flag==true){
			...
			window.location.href = "${pageContext.request.contextPath }/showProductList";
		}
	}
</script>
