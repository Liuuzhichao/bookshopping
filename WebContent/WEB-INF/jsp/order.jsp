...
<body>
		...
		<div class="topbar_content">
			...
			<div class="topbar_content_right">
				<ul>
					...
					<li>|</li>
					<li><a href="${pageContext.request.contextPath }/showCreatOrder">我的订单</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="cart_content">
		...
		<div align="center" id="cart">
			...
			<form action="${pageContext.request.contextPath }/creatOrder"
				method="post">

				<table id="ordertable" width="400px" border="1">
					<tbody>
						<tr style="background: #87520E; color: white; line-height: 40px;">
							<td>&nbsp;&nbsp;收货地址: <input name="receiverinfo"
								style="width: 300px; height: 30px;" type="text">
							</td>
						</tr>
						...
						<tr>
							<td>订单总价:${money }元 <input value="${money }" name="money"
								type="hidden"> <input value="生成订单"
